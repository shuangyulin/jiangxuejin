    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>JxjType/frontlist">奖学金类型</a></li>
                <li><a href="<%=basePath %>Score/frontlist">学生成绩</a></li>
                <li><a href="<%=basePath %>TermInfo/frontlist">学期</a></li>
                <li><a href="<%=basePath %>Family/frontlist">家庭情况</a></li>
                <li><a href="<%=basePath %>Jxj/frontlist">奖学金申请</a></li>

$(function () {
	...
	$("#userInfo_colleageObj_collleageId").combobox({
        ...
        onLoadSuccess: function () { //数据加载完毕事件
            var data = $("#userInfo_colleageObj_collleageId").combobox("getData"); 
            if (data.length > 0) {
                $("#userInfo_colleageObj_collleageId").combobox("select", data[0].collleageId);
            }
        }
	});

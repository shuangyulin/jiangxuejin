	...
	<div class="col-md-12 wow fadeInLeft">
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_colleageObj_collleageId" class="col-md-2 text-right">所在学院:</label>
				  	 <div class="col-md-8">
					    <select id="userInfo_colleageObj_collleageId" name="userInfo.colleageObj.collleageId" class="form-control">
					    </select>
				  	 </div>
				  </div>
				  <div class="form-group">

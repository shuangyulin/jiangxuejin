...
<jsp:include page="../header.jsp"></jsp:include>
		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#termInfoListPanel" aria-controls="termInfoListPanel" role="tab" data-toggle="tab">学期列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>TermInfo/termInfo_frontAdd.jsp" style="display:none;">添加学期</a></li>
				</ul>
			  	<!-- Tab panes -->
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>学期id</td><td>学期名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
				    	            		...
				    	            		for(int i=0;i<termInfoList.size();i++) {
					    	            		...
					    	            		TermInfo termInfo = termInfoList.get(i); //获取到学期对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
 											<td><%=termInfo.getTermId() %></td>
 											<td><%=termInfo.getTermName() %></td>
 											<td>
 												<a href="<%=basePath  %>TermInfo/<%=termInfo.getTermId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="termInfoEdit('<%=termInfo.getTermId() %>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="termInfoDelete('<%=termInfo.getTermId() %>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										<%}%>
				    				</table>
	...
	<div style="display:none;">
		...
		<form name="termInfoQueryForm" id="termInfoQueryForm" action="<%=basePath %>TermInfo/frontlist" class="mar_t15" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;学期信息编辑</h4>
      </div>
